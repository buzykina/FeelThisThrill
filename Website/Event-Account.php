...
<link rel="stylesheet" href="css/GeneralHeader.css">
	...
	<div class ="Campcontainer"><div class ="Set1"><h3>Camp Details</h3></div><div class ="Set2"><p>Row: 22</p><p>NO: R2</p></div><div class="Set3"><div>Himanshu Kotai<div class ="se">Member</div></div><div> Jane Buzykina<div class="se1">Host</div></div><div>Livia Popper<div class = "se">Member</div></div><div>Trung Dung Luong<div class = "se">Member</div></div></div></div>
	</div>
		</div>
		 <?php
