...
<head>
 ...
 <body>
     ...
     <ul id = "submenu1">
        <li><h3><a href="schedule_1.php" class = "Selected">Day 1</a></h3></li>  
        <li><hr></li>
...
<a href="http://i380316.hera.fhict.nl/schedule/day1.pdf"><button class = "schedule">View schedule in pdf</button></a>
</div>
    <?php
