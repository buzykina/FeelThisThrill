...
<?php
      ...
      if(mysqli_num_rows($result)>0):
       ...
       <div class="modal-content">
                <span class="close" id = "cl<?php echo $product['idCamp']; ?>">&times;</span><br>
                    ...
                    <form id = "myForm<?php echo $product['idCamp']; ?>" action="#" onsubmit="return validateFormOnSubmit(this);">
    ...
    <script>
       var modal = document.getElementById('i');
        ...
        var span = document.getElementById("cl");

        // When the user clicks on the button, open the modal 
        document.getElementById("myForm4").onsubmit = function() {
            console.log("hi");
        }
