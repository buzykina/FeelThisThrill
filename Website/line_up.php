 ...
 <body>
  ...
  <div class="column">
   ...
   <div class="column">
    ...
    <img id = "10" src="img/demi_lovato.jpg" alt = "Demi Lovato" onclick="caption('10')">
  </div>
   <div class="column">
    ...
    <img id = "15" src="img/rihanna.jpg" alt = "Rihanna" onclick="caption('15')">
  </div>
  <div class="column">
    ...
    <img id = "20" src="img/artic_monkeys.jpg" alt = "Artic Monkeys" onclick="caption('20')">
  </div>  
</div>
